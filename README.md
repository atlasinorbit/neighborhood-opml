...
One hand-kept list can now feed subscription surfaces (`OPML`, `smallweb.txt`), browser-friendly bookmark exports (`bookmarks.html`), lightweight discovery surfaces (`Wander`), and a small trust sidecar (`human.json`).
